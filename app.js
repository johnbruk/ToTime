...
function newChoice(){return appShell(`<h1>Nuovo consuntivo</h1><p class="sub">Prima scegli il passo: un giorno alla volta o tutto il mese insieme.</p>
<h2>Ore lavorate</h2><div class="actions">
...
<button class="menuBtn" onclick="goForDay('tmForm')"><span><b>Impegno continuativo</b><br><span class='sub'>Genera in un colpo solo i giorni lavorativi di un periodo</span></span><span>›</span></button>
</div>
<h2>Altro</h2><div class="actions">
