...
const tableRows = {
  ...
  timesheet_entries: [
    ...
    { id: 'entry-2', entry_date: `${year}-01-10`, client_id: 'client-1', project_id: 'project-1', activity_id: 'activity-1', hours: 8, daily_rate_snapshot: 800, standard_hours_snapshot: 8 }
  ],
  monthly_compensations: [{ id: 'monthly-1', year, month: monthNumber, client_id: 'client-1', project_id: 'project-1', amount: 1000 }],
  billing_headers: [
    { id: 'billing-jan', year, month: 1, client_id: 'client-1', status: 'collected', invoice_total_amount: 800, collected_amount: 800 },
    { id: 'billing-current', year, month: monthNumber, client_id: 'client-1', status: 'collected', invoice_total_amount: 1500, collected_amount: 1500 }
  ],
...
const projection = window.projectionCalc(year);
assert.equal(projection.year, year);
